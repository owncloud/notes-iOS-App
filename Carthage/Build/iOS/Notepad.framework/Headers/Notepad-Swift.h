...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Notepad",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Notepad7Notepad")
@interface Notepad : UITextView
...
SWIFT_CLASS("_TtC7Notepad7Storage")
...
/// \param location How far into the String to look.
///
/// \param range The range to find attributes for.
///
///
/// returns:
/// The attributes on a String within a certain range.
- (NSDictionary<NSAttributedStringKey, id> * _Nonnull)attributesAtIndex:(NSUInteger)location longestEffectiveRange:(NSRangePointer _Nullable)range inRange:(NSRange)rangeLimit SWIFT_WARN_UNUSED_RESULT;
/// Replaces edited characters within a certain range with a new string.
/// \param range The range to replace.
///
/// \param str The new string to replace the range with.
///
...
/// \param attrs The attributes to add to the string for the range.
///
/// \param range The range in which to add attributes.
///
...
/// \param at The location to begin with.
///
/// \param range The range in which to retrieve attributes.
///
